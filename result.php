...
session_start();
  ...
  $fuck=mysqli_query($connect,"SELECT * FROM quiz ");
    $no=mysqli_num_rows($fuck);
    $p=$no-$quesno;
	$query=mysqli_query($connect,"SELECT * FROM quiz where username='$username' AND subject='$sub'
   AND userans=ans AND num>'$p'");
