...
if(isset($_POST['finish'])){
  ...
  if(isset($_POST['group1'])){
    ...
    $sub=$_SESSION['sub'];
    $iddd=$_SESSION['count'];
    mysqli_query($connect,"INSERT INTO `quiz` (`userans`, `ans`, `username`, `subject`, `id`, `num`) VALUES ('$userans', '$ans',  '$username', '$sub', '$iddd', NULL)");
...
<div class="input-field col s6">
  ...
  <div class="row">
    <div class="input-field col s6">
    <button class="btn waves-effect waves-light" type="submit" value="submit" name="finish" metod="post" >Finish Test
    </button>
  </div>
  <div class="input-field col s6">
    <?php 
